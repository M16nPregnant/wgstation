...
/obj/item/spear/grey_tide
	...
	desc = "Recovered from the aftermath of a revolt aboard Defense Outpost Theta Aegis, in which a seemingly endless tide of Assistants caused heavy casualities among Genesis military forces." //GS13 - Nanotrasen to GATO
	throwforce = 20
	throw_speed = 4
