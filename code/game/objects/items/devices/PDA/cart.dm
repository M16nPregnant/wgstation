...
/obj/item/cartridge/lawyer
	...
	desc = "Introducing the Station Public Announcement Messenger cartridge, featuring the unique ability to broadcast-mark messages, designed for lawyers across Genesis to advertise their useful and important services." //GS13 - Nanotrasen to GATO
	icon_state = "cart-law"
	access = CART_SECURITY
	spam_enabled = 1
