...
/obj/item/bombcore/training
	name = "dummy payload"
	desc = "A Genesis replica of a syndicate payload. Its not intended to explode but to announce that it WOULD have exploded, then rewire itself to allow for more training." //GS13 - Nanotrasen to GATO
	var/defusals = 0
	var/attempts = 0
