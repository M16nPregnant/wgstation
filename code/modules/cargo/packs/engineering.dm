...
/datum/supply_pack/engineering/shieldgen
	...
	desc = "Hull breaches again? Say no more with the Genesis Anti-Breach Shield Projector! Uses forcefield technology to keep the air in, and the space out. Contains two shield projectors." //GS13 - Nanotrasen to GATO
	cost = 2500
...
/datum/supply_pack/engineering/bsa
	...
	desc = "The pride of Genesis Naval Command. The legendary Bluespace Artillery Cannon is a devastating feat of human engineering and testament to wartime determination. Highly advanced research is required for proper construction. " //GS13 - Nanotrasen to GATO
	cost = 15000
	special = TRUE
