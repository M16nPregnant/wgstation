/obj/item/mmi
	...
	desc = "The Warrior's bland acronym, MMI, obscures the true horror of this monstrosity, that nevertheless has become standard-issue on Genesis stations." //GS13 - Nanotrasen to GATO
