...
/obj/item/gun/ballistic/automatic/magrifle/hyperburst
	...
	desc = "An extremely beefed up version of a stolen Genesis weapon prototype, this 'rifle' is more like a cannon, with an extremely large bore barrel capable of generating several smaller magnetic 'barrels' to simultaneously launch multiple projectiles at once." //GS13 - Nanotrasen to GATO
