...
/obj/item/gun/energy/pulse/pistol/m1911
	...
	desc = "A compact pulse core in a classic handgun frame for Genesis officers. It's not the size of the gun, it's the size of the hole it puts through people." //GS13 - Nanotrasen to GATO
	icon_state = "m1911"
	item_state = "gun"
	cell_type = /obj/item/stock_parts/cell/infinite
	modifystate = FALSE
