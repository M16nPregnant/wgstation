...
/obj/item/clothing/suit/space/hardsuit/captain
	...
	desc = "A MK.II SWAT suit with streamlined joints and armor made out of superior materials, insulated against intense heat. The most advanced tactical armor available Usually reserved for heavy hitter corporate security, this one has a regal finish in Genesis company colors. Better not let the assistants get a hold of it." //GS13 - Nanotrasen to GATO
	icon_state = "caparmor"
