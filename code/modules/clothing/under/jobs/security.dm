...
/obj/item/clothing/under/rank/security/officer
	...
	desc = "A tactical security jumpsuit for officers complete with Genesis belt buckle." //GS13 - Nanotrasen to GATO
...
/obj/item/clothing/under/rank/security/officer/grey
	...
	desc = "A tactical relic of years past before Genesis decided it was cheaper to dye the suits red instead of washing out the blood." //GS13 - Nanotrasen to GATO
	icon_state = "security"
	item_state = "gy_suit"
...
/obj/item/clothing/under/rank/security/warden
	name = "security suit"
	desc = "A formal security suit for officers complete with Genesis belt buckle." //GS13 - Nanotrasen to GATO
	icon_state = "rwarden"
	item_state = "r_suit"
	armor = list(MELEE = 10, BULLET = 0, LASER = 0,ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 30, ACID = 30, WOUND = 10)
...
/obj/item/clothing/under/rank/security/warden/grey
	...
	desc = "A formal relic of years past before Genesis decided it was cheaper to dye the suits red instead of washing out the blood." //GS13 - Nanotrasen to GATO
	icon_state = "warden"
	item_state = "gy_suit"

/obj/item/clothing/under/rank/security/warden/skirt
	name = "warden's suitskirt"
	desc = "A formal security suitskirt for officers complete with Genesis belt buckle." //GS13 - Nanotrasen to GATO
