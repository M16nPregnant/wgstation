...
/obj/item/clothing/mask/gas/cluwne/happy_cluwne
	...
	desc = "The mask of a poor cluwne that has been scrubbed of its curse by the Genesis supernatural machinations division. Guaranteed to be %99 curse free and %99.9 not haunted. " //GS13 - Nanotrasen to GATO
	item_flags = ABSTRACT
