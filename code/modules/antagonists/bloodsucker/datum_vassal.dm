...
/datum/antagonist/vassal/greet()
	...
	to_chat(owner, "<span class='boldannounce'>The power of [master.owner.current.p_their()] immortal blood compells you to obey [master.owner.current.p_them()] in all things, even offering your own life to prolong theirs.<br>\
			You are not required to obey any other Bloodsucker, for only [master.owner.current] is your master. The laws of Genesis do not apply to you now; only your vampiric master's word must be obeyed.<span>") //GS13 - Nanotrasen to GATO
	// Effects...
