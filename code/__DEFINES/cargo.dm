...
GLOBAL_LIST_INIT(podstyles, list(\
	...
	list(POD_SHAPE_NORML, "darkpod",     TRUE, "deathsquad",	"blue",     RUBBLE_NORMAL,	"\improper Deathsquad drop pod", 	    "A Genesis drop pod. This one has been marked the markings of GATO's elite strike team."),\
