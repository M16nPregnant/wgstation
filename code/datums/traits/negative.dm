...
/datum/quirk/lightless
	...
	desc = "Bright lights irritate you. Your eyes start to water, your skin feels itchy against the photon radiation, and your hair gets dry and frizzy. Maybe it's a medical condition. If only Genesis was more considerate of your needs..." //GS13 - Nanotrasen to GATO
	value = -1
