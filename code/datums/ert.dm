...
/datum/ert/New()
	if (!polldesc)
		polldesc = "a Code [code] Genesis Emergency Response Team" //GS13 - Nanotrasen to GATO
...
/datum/ert/deathsquad
	...
	polldesc = "an elite Genesis Strike Team" //GS13 - Nanotrasen to GATO
...
/datum/ert/inquisition
	...
	polldesc = "a Genesis paranormal response team" //GS13 - Nanotrasen to GATO
