...
/obj/item/storage/fancy/cigarettes/gatito
	...
	desc = "A heavenly sensation for you lungs!"
...
/obj/item/banner/gato
	name = "World Genesis banner"
	desc = "The banner of WG, expanding man's horizons!"
	icon = 'GainStation13/icons/obj/items_and_weapons.dmi'
	icon_state = "banner_gato"
	job_loyalties = list("Command")
	warcry = "FIGHT TO CLEANSE YOUR SINS OR DIE WITH THEM!"
